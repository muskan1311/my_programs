...
if __name__ == '__main__':
    ...
    phoneslist_amazon_df = pd.DataFrame.from_dict(d)
    phoneslist_amazon_df['title'].replace('', np.nan, inplace=True)
    phoneslist_amazon_df = phoneslist_amazon_df.dropna(subset=['title'])
    phoneslist_amazon_df.to_csv("phoneslist_amazon.csv", header=True, index=False)
